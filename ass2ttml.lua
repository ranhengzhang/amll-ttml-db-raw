...
local ui_config = {
    {
        ...
        y = 0,
        width = 1
    }, {class = "edit", name = "ncmMusicIds", x = 1, y = 0, width = 3}, {
        class = "label",
        label = "QQ 音乐 ID(s)",
        name = "tag_qqMusicId",
        x = 0,
        y = 1,
        width = 1
    }, {class = "edit", name = "qqMusicIds", x = 1, y = 1, width = 3}, {
        class = "label",
        ...
        y = 2,
        width = 1
    }, {class = "edit", name = "spotifyIds", x = 1, y = 2, width = 3}, {
        class = "label",
        ...
        y = 3,
        width = 1
    }, {class = "edit", name = "appleMusicIds", x = 1, y = 3, width = 3}, {
        class = "label",
        label = "歌曲的 ISRC 号码(s)",
        name = "tag_isrc",
        x = 0,
        y = 4,
        width = 1
    }, {class = "edit", name = "isrcs", x = 1, y = 4, width = 3}, {
        class = "label",
        label = "歌曲作者",
        name = "tag_artists",
        x = 4,
        y = 0,
        width = 1
    }, {class = "edit", name = "artistss", x = 5, y = 0, width = 3}, {
        class = "label",
        label = "歌曲专辑",
        name = "tag_album",
        x = 4,
        y = 1,
        width = 1
    }, {class = "edit", name = "albums", x = 5, y = 1, width = 3}, {
        class = "label",
        label = "歌曲名称",
        name = "tag_musicName",
        x = 4,
        y = 2,
        width = 1
    }, {class = "edit", name = "musicNames", x = 5, y = 2, width = 3}, {
        class = "label",
        ...
        y = 3,
        width = 1
    }, {class = "edit", name = "ttmlAuthorGithubs", x = 5, y = 3, width = 3}, {
        class = "label",
    ...
    {class = "edit", name = "ttmlAuthorGithubLogins", x = 5, y = 4, width = 3}
}
...
function generate_meta(key, value)
    ...
    if key ~= 'musicName' then values = split(value) end
